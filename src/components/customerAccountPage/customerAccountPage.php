                    ...
                    <form class="profile-pic-div" name="profile-pic" id="profile-pic" method="post" action="edit_profile.php">
                        <div class="image-upload">
                            <label for="file-input">
                                <img id="profile-pic" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBQjQVne9Bl-9G4uf4Gk9oTr3WPLI8hpigUw&usqp=CAU" alt="change ava button" class="change-ava-btn form-control">
                            </label>
