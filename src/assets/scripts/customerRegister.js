...
function clicked(e) {
  ...
  else if (e.target.checked && e.target.id == "vendor") {
    loadVendor();
...
function validateInput(e) {
  ...
  switch (checkUserName(userName.value.trim())) {
    case 0:
      e.preventDefault();
    ...
    /*case 1:
      e.preventDefault();
      alert("User name has existed please choose another!");
      return;*/
  }
...
function checkUserName(input) {
  //Return 0: invalid, 1: userName is existed, 2: valid
